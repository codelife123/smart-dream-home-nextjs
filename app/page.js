      ...
      <div id="productModal" className="fixed inset-0 bg-black bg-opacity-60 hidden z-50 items-center justify-center p-4">
        <div className="bg-white rounded-2xl p-4 max-w-2xl w-full relative">
          ...
          <div className="flex flex-col md:flex-row gap-4">
            {modalImgSrc ? (
              <Image id="modalImg" src={modalImgSrc} alt="Product image - Smart home device from Smart Dream Home Lanka" width={192} height={192} className="w-full md:w-48 h-48 object-cover rounded-lg" />
            ) : null}
